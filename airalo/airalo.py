...
class Airalo:
    ...
    def _init_resources(self, config: Union[Dict[str, Any], Config, str]) -> None:
        ...
        self._multi_http = self._pool.get('multi_curl') or MultiHttpResource(self._config)
    ...
    def order(self, package_id: str, quantity: int,
    ...
    def order_with_email_sim_share(self, package_id: str, quantity: int,
    ...
    def order_async(self, package_id: str, quantity: int,
    ...
    def order_bulk(self, packages: Union[Dict[str, int], List[Dict]],
                  description: Optional[str] = None) -> Optional[Dict]:
        """
        Create bulk orders.
    ...
    def order_bulk_with_email_sim_share(self, packages: Union[Dict[str, int], List[Dict]],
                                        esim_cloud: Dict[str, Any],
                                        description: Optional[str] = None) -> Optional[Dict]:
        """
        ...
        if not packages:
            return None
        return self._order.create_order_bulk_with_email_sim_share(packages, esim_cloud, description)

    def order_async_bulk(self, packages: Union[Dict[str, int], List[Dict]],
                        webhook_url: Optional[str] = None,
                        description: Optional[str] = None) -> Optional[Dict]:
        """
